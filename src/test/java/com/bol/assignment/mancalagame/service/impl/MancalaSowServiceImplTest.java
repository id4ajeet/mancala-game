...
import static com.bol.assignment.mancalagame.model.Status.IN_PROGRESS;
...
class MancalaSowServiceImplTest {
    ...
    void testSowFromMainPitOfPlayer1() {
        ...
        assertEquals(gameNoChange, sowGame);
    ...
    void testSowValidFirstMove() {
        ...
        //THEN
        var gameNoChange = createGame(true);
        assertNotEquals(gameNoChange, sowGame);
